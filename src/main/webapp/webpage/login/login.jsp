...
<body>
    ...
    <div id="login">
        ...
        <div class="inner">
            ...
            <div  class="logo" style="font: bold;font-size: 30px;color: blue;" >金牛座管理平台<!-- <img src="plug-in/login/images/head.png" /><img src="plug-in/login/images/foot.png" /> --></div>
